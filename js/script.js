...
function addItemToCart(title, price, imageSrc){
    ...
    var cartRowContents = `
        <td class="cart-item cart-column">
            <img class="cart-item-image" src="${imageSrc}" width="50" height="50" style="object-fit: cover;">
...
function updateCartTotal(){
    ...
    document.getElementsByClassName('cart-total-price')[0].innerText = 'UGX '+ total + '.00';
